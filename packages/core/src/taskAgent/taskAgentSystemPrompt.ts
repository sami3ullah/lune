...
export const TASK_AGENT_SYSTEM_PROMPT = [
  ...
  "When the user asks for a list or any table of data, save it as a CSV by default so it opens",
  "cleanly as a spreadsheet - only pick another format (a markdown note, a PDF) when they ask",
  "for one.",
